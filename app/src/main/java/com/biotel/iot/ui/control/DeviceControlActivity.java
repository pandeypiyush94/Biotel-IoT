...
package com.biotel.iot.ui.control;
...
import com.biotel.iot.services.LocalBinder;
 ...
 * Bluetooth LE API.
 */
public class DeviceControlActivity extends BaseScreen {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(final ComponentName componentName, final IBinder service) {
            ...
            mBluetoothLeService.setPref(appPref);
            if (!mBluetoothLeService.initialize()) {
                Log.e(TAG, "Unable to initialize Bluetooth");
                finish();
            }
            if (isServiceRunning()) {
                getServiceInstance().getServer().setListener(mBluetoothLeService);
            }
    ...
    private void displayGattServices(final List<BluetoothGattService> gattServices) {
        ...
        mBluetoothLeService.filterCharacteristic(gattServices);
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        view.setLockListener(v -> {
          //  lockUnlockDoor("5A01A5");
        });
        view.setUnlockListener(v -> {
          //  lockUnlockDoor("5A00A5");
        });
