...
internal class View(activity: Activity) {
    ...
    private var btnLock: Button = activity.findViewById(R.id.btn_lock)
    private var btnUnlock: Button = activity.findViewById(R.id.btn_unlock)
    ...
    fun setLockListener(listener : View.OnClickListener) {
        btnLock.setOnClickListener(listener)
    }

    fun setUnlockListener(listener : View.OnClickListener) {
